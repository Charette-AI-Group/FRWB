...
Shared across the Charette AI Group applications so they look like they come
from the same place: the same credits block, the same yellow Donate button,
the same PayPal link.

A plain QDialog rather than QMessageBox.about, for a reason worth keeping: a
